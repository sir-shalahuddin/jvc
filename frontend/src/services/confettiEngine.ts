// Canvas Confetti Particle Engine for Celebrations & Votes
...
class ConfettiEngine {
  ...
  private colors = ['#ff5f1f', '#10b981', '#1a1a1a', '#fdfaf6', '#3b82f6', '#fbbf24', '#ec4899'];

  public attachCanvas(canvas: HTMLCanvasElement | null) {
    if (!canvas) return;
    this.canvas = canvas;
  ...
  public fire(opts: { particleCount?: number; spread?: number; x?: number; y?: number } = {}) {
